...
engine = sqlalchemy.create_engine('postgresql://webadmin:IKQcmg16377@node37016-nititat.proen.app.ruk-com.cloud:11257/hw2')
...
user2 = Students(
    ...
    S_f_name='Kongphop',
    S_l_name='Sri-on',
    S_e_mail ='6406022610015@kmutnb.ac.th'
)
...
user3 = Students(
    ...
    S_f_name='Watcharakorn',
    S_l_name='Yentaweesuv',
    S_e_mail ='6406022620053@kmutnb.ac.th'
)
